...
`,Qt=l.forwardRef(function(t,e){const a=ct({props:t,name:"MuiTouchRipple"}),{center:o=!1,classes:i={},className:s,...p}=a,[u,f]=l.useState([]),d=l.useRef(0),M=l.useRef(null);l.useEffect(()=>{M.current&&(M.current(),M.current=null)},[u]);const g=l.useRef(!1),V=vt(),h=l.useRef(null),L=l.useRef(null),E=l.useCallback(c=>{const{pulsate:R,rippleX:b,rippleY:I,rippleSize:w,cb:U}=c;f(y=>[...y,N.jsx(Jt,{classes:{ripple:x(i.ripple,m.ripple),rippleVisible:x(i.rippleVisible,m.rippleVisible),ripplePulsate:x(i.ripplePulsate,m.ripplePulsate),child:x(i.child,m.child),childLeaving:x(i.childLeaving,m.childLeaving),childPulsate:x(i.childPulsate,m.childPulsate)},timeout:J,pulsate:R,rippleX:b,rippleY:I,rippleSize:w},d.current)]),d.current+=1,M.current=U},[i]),$=l.useCallback((c={},R={},b=()=>{})=>{const{pulsate:I=!1,center:w=o||R.pulsate,fakeElement:U=!1}=R;if((c==null?void 0:c.type)==="mousedown"&&g.current){g.current=!1;return}(c==null?void 0:c.type)==="touchstart"&&(g.current=!0);const y=U?null:L.current,B=y?y.getBoundingClientRect():{width:0,height:0,left:0,top:0};let S,C,D;if(w||c===void 0||c.clientX===0&&c.clientY===0||!c.clientX&&!c.touches)S=Math.round(B.width/2),C=Math.round(B.height/2);else{const{clientX:z,clientY:j}=c.touches&&c.touches.length>0?c.touches[0]:c;S=Math.round(z-B.left),C=Math.round(j-B.top)}if(w)D=Math.sqrt((2*B.width**2+B.height**2)/3),D%2===0&&(D+=1);else{const z=Math.max(Math.abs((y?y.clientWidth:0)-S),S)*2+2,j=Math.max(Math.abs((y?y.clientHeight:0)-C),C)*2+2;D=Math.sqrt(z**2+j**2)}c!=null&&c.touches?h.current===null&&(h.current=()=>{E({pulsate:I,rippleX:S,rippleY:C,rippleSize:D,cb:b})},V.start(Kt,()=>{h.current&&(h.current(),h.current=null)})):E({pulsate:I,rippleX:S,rippleY:C,rippleSize:D,cb:b})},[o,E,V]),Y=l.useCallback(()=>{$({},{pulsate:!0})},[$]),F=l.useCallback((c,R)=>{if(V.clear(),(c==null?void 0:c.type)==="touchend"&&h.current){h.current(),h.current=null,V.start(0,()=>{F(c,R)});return}h.current=null,f(b=>b.length>0?b.slice(1):b),M.current=R},[V]);return l.useImperativeHandle(e,()=>({pulsate:Y,start:$,stop:F}),[Y,$,F]),N.jsx(qt,{className:x(m.root,i.root,s),ref:L,...p,children:N.jsx(et,{component:null,exit:!0,children:u})})});function Zt(n){return Lt("MuiButtonBase",n)}const te=ut("MuiButtonBase",["root","disabled","focusVisible"]),ee=n=>{const{disabled:t,focusVisible:e,focusVisibleClassName:a,classes:o}=n,s=wt({root:["root",t&&"disabled",e&&"focusVisible"]},Zt,o);return e&&a&&(s.root+=` ${a}`),s},ne=Q("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(n,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${te.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),he=l.forwardRef(function(t,e){const a=ct({props:t,name:"MuiButtonBase"}),{action:o,centerRipple:i=!1,children:s,className:p,component:u="button",disabled:f=!1,disableRipple:d=!1,disableTouchRipple:M=!1,focusRipple:g=!1,focusVisibleClassName:V,LinkComponent:h="a",onBlur:L,onClick:E,onContextMenu:$,onDragLeave:Y,onFocus:F,onFocusVisible:c,onKeyDown:R,onKeyUp:b,onMouseDown:I,onMouseLeave:w,onMouseUp:U,onTouchEnd:y,onTouchMove:B,onTouchStart:S,tabIndex:C=0,TouchRippleProps:D,touchRippleRef:z,type:j,...O}=a,A=l.useRef(null),T=Xt(),pt=at(T.ref,z),[k,_]=l.useState(!1);f&&k&&_(!1),l.useImperativeHandle(o,()=>({focusVisible:()=>{_(!0),A.current.focus()}}),[]);const ft=T.shouldMount&&!d&&!f;l.useEffect(()=>{k&&g&&!d&&T.pulsate()},[d,g,k,T]);function P(r,ot,Bt=M){return H(it=>(ot&&ot(it),Bt||T[r](it),!0))}const dt=P("start",I),ht=P("stop",$),mt=P("stop",Y),gt=P("stop",U),bt=P("stop",r=>{k&&r.preventDefault(),w&&w(r)}),Mt=P("start",S),Rt=P("stop",y),yt=P("stop",B),xt=P("stop",r=>{lt(r.target)||_(!1),L&&L(r)},!1),Et=H(r=>{A.current||(A.current=r.currentTarget),lt(r.target)&&(_(!0),c&&c(r)),F&&F(r)}),q=()=>{const r=A.current;return u&&u!=="button"&&!(r.tagName==="A"&&r.href)},Ct=H(r=>{g&&!r.repeat&&k&&r.key===" "&&T.stop(r,()=>{T.start(r)}),r.target===r.currentTarget&&q()&&r.key===" "&&r.preventDefault(),R&&R(r),r.target===r.currentTarget&&q()&&r.key==="Enter"&&!f&&(r.preventDefault(),E&&E(r))}),Tt=H(r=>{g&&r.key===" "&&k&&!r.defaultPrevented&&T.stop(r,()=>{T.pulsate(r)}),b&&b(r),E&&r.target===r.currentTarget&&q()&&r.key===" "&&!r.defaultPrevented&&E(r)});let K=u;K==="button"&&(O.href||O.to)&&(K=h);const X={};K==="button"?(X.type=j===void 0?"button":j,X.disabled=f):(!O.href&&!O.to&&(X.role="button"),f&&(X["aria-disabled"]=f));const Pt=at(e,A),nt={...a,centerRipple:i,component:u,disabled:f,disableRipple:d,disableTouchRipple:M,focusRipple:g,tabIndex:C,focusVisible:k},Vt=ee(nt);return N.jsxs(ne,{as:K,className:x(Vt.root,p),ownerState:nt,onBlur:xt,onClick:E,onContextMenu:ht,onFocus:Et,onKeyDown:Ct,onKeyUp:Tt,onMouseDown:dt,onMouseLeave:bt,onMouseUp:gt,onDragLeave:mt,onTouchEnd:Rt,onTouchMove:yt,onTouchStart:Mt,ref:Pt,tabIndex:f?-1:C,type:j,...X,...O,children:[s,ft?N.jsx(Qt,{ref:pt,center:i,...D}):null]})});export{he as B,lt as i};
